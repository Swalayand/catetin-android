...
public class WifiBase {
  ...
  private void showWifiDisabledDialog() {
    new AlertDialog.Builder(getContext())
      ...
      .setNegativeButton(getContext().getString(R.string.still_disable_wifi), new DialogInterface.OnClickListener() {
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      if (!found) {
        ...
        new AlertDialog.Builder(context)
          ...
          .setPositiveButton(context.getString(R.string.close_dialog), new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
        ...
        getActivity().runOnUiThread(new Runnable() {
          ...
          public void run() {
            ...
            new AlertDialog.Builder(getContext())
              ...
              .setPositiveButton(getContext().getString(R.string.close_dialog), new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                  getActivity().finish();
                }
              })
